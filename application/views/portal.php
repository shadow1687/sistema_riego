...
<head>
    ...
    <!-- Morris Charts CSS -->
    <link href=<?php echo  base_url() ."bootstrap/vendor/morrisjs/morris.css"?> rel="stylesheet">
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Sistema de Riego v0.0</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-wrench fa-fw"></i> Panel de Control<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="panels-wells.html">ESP1</a>
                                </li>
                                <li>
                                    <a href="panels-wells.html">ESP2</a>
                                </li>
                                <li>
                                    <a href="panels-wells.html">ESP3</a>
                                </li>
                                <li>
                                    <a href="panels-wells.html">ESP4</a>
                                </li>
                             </ul>
                            <!-- /.nav-second-level -->
                        </li>
    ...
    <script src=<?php echo  base_url() . "bootstrap/vendor/raphael/raphael.min.js"?> ></script>
    <script src=<?php echo  base_url() . "bootstrap/vendor/morrisjs/morris.min.js"?> ></script>
    <script src=<?php echo  base_url() . "bootstrap/data/morris-data.js"?> ></script>
